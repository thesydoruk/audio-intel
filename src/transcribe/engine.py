...
class WhisperEngine:
    ...
    def transcribe_array(
        ...
        *,
        ...
        ``word_timestamps`` overrides the runtime default (disabled when CTC will replace words).
        """
    ...
    def _decode(
        ...
        *,
        ...
        use_word_timestamps = (
            runtime.word_timestamps if word_timestamps is None else word_timestamps
        )
