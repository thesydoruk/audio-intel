...
class SpeakerMergeTests(unittest.TestCase):
    ...
    def test_splits_one_whisper_segment_at_speaker_change(self):
        ...
        self.assertEqual(
            [word["word"] for word in assigned[0]["words"]],
            [" Hello", " there"],
        )
        self.assertEqual([word["word"] for word in assigned[1]["words"]], [" Yes"])
        self.assertEqual(
            roster,
            [
    ...
    def test_keeps_words_when_intervals_missing(self):
        segments = [
            {
                "start": 0.0,
                "end": 1.0,
        ...
        self.assertEqual(assigned[0]["words"], [{"start": 0.0, "end": 1.0, "word": " Hi"}])
        self.assertEqual(roster, [])
