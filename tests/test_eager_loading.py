...
class AlignmentPreloadLanguagesTest(unittest.TestCase):
    def test_uses_alignment_language_when_set(self) -> None:
        cfg = replace(load_config(), alignment_language="uk", alignment_preload=())
    ...
    def test_defaults_to_ukrainian_and_english(self) -> None:
        cfg = replace(
            load_config(),
            alignment_language=None,
        ...
        self.assertEqual(alignment_preload_languages(cfg), ("uk", "en"))

    def test_uses_explicit_preload_list(self) -> None:
        cfg = replace(
            load_config(),
            alignment_language=None,
            forced_language=None,
            alignment_preload=("uk",),
        )
        self.assertEqual(alignment_preload_languages(cfg), ("uk",))
