...
speakers are linked via a running embedding gallery (overlap first, then any prior
speaker) plus a post-pass merge on roster embeddings. Chunk inference runs
**in parallel** (`SPEAKERS_PARALLEL_WORKERS` pipeline copies).
